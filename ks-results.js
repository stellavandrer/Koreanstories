...
(function (global) {
  ...
  function show(opts) {
    ...
    if (sk > 1) {
      statsHtml += '<div class="ks-stat"><div class="ks-stat-n" style="color:#FF8050;font-size:20px"><svg class="ks-i" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#FF8050" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="vertical-align:middle"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5Z"/></svg> '+sk+'</div><div class="ks-stat-l">jours de suite</div></div>';
    }
